...
const Dialog = ({ open, onOpenChange, ...props }: React.ComponentProps<typeof DialogPrimitive.Root>) => {
  ...
  return <DialogRoot open={open} onOpenChange={onOpenChange} {...props} />;
};
...
interface DialogContentProps
  ...
  /** `fade`: solo opacidad, sin zoom ni slide (evita el efecto diagonal). */
  animation?: 'default' | 'fade';
}

const dialogContentAnimationClasses = {
  default:
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        dialogContentAnimationClasses[animation],
        className,
      )}
      {...props}
    >
